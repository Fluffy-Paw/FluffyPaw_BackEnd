...
namespace FluffyPaw_Infrastructure.Migrations
{
    ...
    [Migration("20241219125407_FluffyPaw")]
            ...
            modelBuilder.Entity("FluffyPaw_Domain.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTimeOffset(new DateTime(2024, 12, 20, 2, 54, 7, 463, DateTimeKind.Unspecified).AddTicks(264), new TimeSpan(0, 7, 0, 0, 0)),
